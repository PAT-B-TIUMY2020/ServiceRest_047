...
namespace ServiceRest_047_ImamZakky
{
    ...
    public class TI_UMY : ITI_UMY
    {
        ...
        {
            string msg = "GAGAL";
            SqlConnection sqlcon = new SqlConnection("Data Source=DESKTOP-GNFF4FB;Database=TI UMY;User Id=sa;Password=12345;Trusted_Connection=True;MultipleActiveResultSets=true");
        ...
        {
            {
                ...
                SqlConnection con = new SqlConnection("Data Source=DESKTOP-GNFF4FB;Database=TI UMY;User Id=sa;Password=12345;Trusted_Connection=True;MultipleActiveResultSets=true");
        ...
        {
            Mahasiswa mhs = new Mahasiswa();
            SqlConnection con = new SqlConnection("Data Source=DESKTOP-GNFF4FB;Initial Catalog=TI UMY;Persist Security Info=True;User ID=sa; Password=12345");
